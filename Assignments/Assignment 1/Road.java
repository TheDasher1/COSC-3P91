public class Road {
    ...
    private int roadID, maxVehiclesPerLane;
    // private Lane[] lanes;
    ...
    public Road(String RoadName, int RoadID, int MAXVehiclesPerLane, Intersection TopIntersection, Intersection BottomIntersection) {
        this.roadName = RoadName;
        this.roadID = RoadID;
        this.maxVehiclesPerLane = MAXVehiclesPerLane;
        // this.lanes = new Lane[this.maxVehiclesPerLane];
